        ...
        <>
          ...
          <div className='container mx-auto px-3 flex flex-col gap-4 lg:gap-10 lg:flex-row min-h-screen '>
            ...
            <div className='-mt-8 lg:-mt-28 relative min'>
              ...
              <div className='w-full max-w-60 bg-white px-3 py-2 text-black font-bold rounded mt-4 hover:bg-gradient-to-l from-red-700 to-orange-500 hover:scale-105 shadow-md transition-all duration-500 block mb-2 text-center mx-auto' onClick={() => {
            ...
            <div className='my-4 w-full'>
              ...
              <div className=''>
                ...
                <div className=' w-full flex items-center gap-2 lg:gap-4 py-2 pt-0 border-b border-neutral-600 my-2 flex-wrap text-sm md:text-base'>
                  <p>Budget: ${deatilData?.budget}</p>
                  |
                  <p>Revenue : ${deatilData?.revenue}</p>
                </div>
